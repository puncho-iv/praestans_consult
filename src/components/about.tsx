...
const about = () => {
  return (
    <div className="min-h-screen lg:p-64 p-12 " id="about">
      <h3 className="text-5xl flex justify-center mt-0 lg:mt-32">Abouts Us</h3>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 text-lg mt-8">
